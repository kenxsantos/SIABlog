    ...
    <div class="nav-bar">
        ...
        <div class="profile-icon">
            <a href="<?= base_url('index.php/user/edit_profile') ?>" style="display: block;">
                <img src="<?= base_url('assets/images/user-icon.png') ?>" alt="Profile"
        ...
        <div class="post-box position-relative">
            ...
            <div class="custom-actions">
                ...
                <div class="action-menu">
                    <a href="<?= site_url('user/edit_post/' . $post['post_id']) ?>" class="action-button edit-btn">Edit
                        Post</a>
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <!-- Show tag name here -->
                    <span class="badge bg-primary"><?= htmlspecialchars($post['tag_id']) ?></span>
                </div>
                <div>
