            ...
            <div>
                ...
                <div class="custom-actions d-inline-block">
                    ...
                    <div class="action-menu">
                        <button class="edit"
                            onclick="window.location.href='<?= base_url('index.php/admin/edit_user/' . $user['user_id']) ?>'">Edit
                            User</button>
                        <button class="delete" onclick="showConfirmModal(<?= $user['user_id'] ?>)">Delete User</button>
                    </div>
                </div>
            </div>
        </div>
